...
public class AES {
	...
	private static byte[] xor_func(byte[] a, byte[] b) {
        ...
        //Method for generation of subkeys
	...
	private static byte[] rotateWord(byte[] input) {
        ...
        //Method for adding rounding key
...
'H', 'U', 'T', 'H','E', 'B', 'E', 'S', 'T' };
        ...
        String asd=new String(keyValue);
        System.out.println("The key is: "+new String(asd.getBytes()));
        
        System.out.println("Plain text: "+password);
        
        int start=(int) System.currentTimeMillis();
        byte enc[]=encrypt(in,keyValue);
